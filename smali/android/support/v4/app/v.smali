...
.method public static a(Ljava/lang/Object;Landroid/view/View;Ljava/util/ArrayList;Ljava/util/Map;Landroid/view/View;)Ljava/lang/Object;
    ...
    .line 46
    invoke-static {p2, p1}, Landroid/support/v4/app/v;->b(Ljava/util/ArrayList;Landroid/view/View;)V
    ...
    invoke-static {v0, p2}, Landroid/support/v4/app/v;->b(Ljava/lang/Object;Ljava/util/ArrayList;)V
...
.method private static a(Landroid/transition/Transition;Landroid/support/v4/app/v$a;)V
    .locals 1
    ...
    invoke-direct {v0, p1}, Landroid/support/v4/app/v$3;-><init>(Landroid/support/v4/app/v$a;)V
...
.method static synthetic a(Landroid/transition/Transition;Landroid/transition/Transition;Ljava/util/ArrayList;Z)V
    ...
    .prologue
    .line 31
    invoke-static {p0, p1, p2, p3}, Landroid/support/v4/app/v;->b(Landroid/transition/Transition;Landroid/transition/Transition;Ljava/util/ArrayList;Z)V
...
.method public static a(Ljava/lang/Object;Landroid/view/View;)V
    ...
    .line 72
    invoke-static {p1}, Landroid/support/v4/app/v;->c(Landroid/view/View;)Landroid/graphics/Rect;
    ...
    invoke-direct {v1, v0}, Landroid/support/v4/app/v$1;-><init>(Landroid/graphics/Rect;)V
...
.method public static a(Ljava/lang/Object;Landroid/view/View;Ljava/util/Map;Ljava/util/ArrayList;)V
    ...
    .line 277
    invoke-static {p0, p3}, Landroid/support/v4/app/v;->b(Ljava/lang/Object;Ljava/util/ArrayList;)V
...
.method public static a(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Landroid/view/View;Landroid/support/v4/app/v$b;Landroid/view/View;Landroid/support/v4/app/v$a;Ljava/util/Map;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/Map;Ljava/util/Map;Ljava/util/ArrayList;)V
    .locals 13
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v5, v11, v0, v4}, Landroid/support/v4/app/v;->b(Landroid/transition/Transition;Landroid/transition/Transition;Ljava/util/ArrayList;Z)V
    ...
    invoke-static {v3, v0, v1, v2}, Landroid/support/v4/app/v;->a(Ljava/lang/Object;Landroid/view/View;Ljava/util/Map;Ljava/util/ArrayList;)V
    ...
    invoke-static {v5, v3, v0, v4}, Landroid/support/v4/app/v;->b(Landroid/transition/Transition;Landroid/transition/Transition;Ljava/util/ArrayList;Z)V
    ...
    invoke-static {v11, v3, v0, v4}, Landroid/support/v4/app/v;->b(Landroid/transition/Transition;Landroid/transition/Transition;Ljava/util/ArrayList;Z)V
    ...
    new-instance v3, Landroid/support/v4/app/v$2;
    ...
    invoke-direct/range {v3 .. v11}, Landroid/support/v4/app/v$2;-><init>(Landroid/view/View;Landroid/transition/Transition;Landroid/view/View;Landroid/support/v4/app/v$b;Ljava/util/Map;Ljava/util/Map;Ljava/util/ArrayList;Landroid/transition/Transition;)V
    ...
    invoke-static {v5, v0}, Landroid/support/v4/app/v;->a(Landroid/transition/Transition;Landroid/support/v4/app/v$a;)V
...
.method public static a(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/util/ArrayList;Z)V
    ...
    .line 121
    invoke-static {p0, p2, p3, p4}, Landroid/support/v4/app/v;->b(Landroid/transition/Transition;Landroid/transition/Transition;Ljava/util/ArrayList;Z)V

    .line 122
    invoke-static {p1, p2, p3, p4}, Landroid/support/v4/app/v;->b(Landroid/transition/Transition;Landroid/transition/Transition;Ljava/util/ArrayList;Z)V
...
.method public static a(Ljava/lang/Object;Ljava/util/ArrayList;)V
    ...
    .line 438
    invoke-static {v2, p1}, Landroid/support/v4/app/v;->a(Ljava/lang/Object;Ljava/util/ArrayList;)V
    ...
    .line 440
    :cond_0
    invoke-static {p0}, Landroid/support/v4/app/v;->a(Landroid/transition/Transition;)Z
...
.method static synthetic a(Ljava/util/ArrayList;Landroid/view/View;)V
    ...
    .prologue
    .line 31
    invoke-static {p0, p1}, Landroid/support/v4/app/v;->b(Ljava/util/ArrayList;Landroid/view/View;)V
...
.method private static a(Ljava/util/List;Landroid/view/View;)V
    ...
    .line 286
    invoke-static {p0, p1, v2}, Landroid/support/v4/app/v;->a(Ljava/util/List;Landroid/view/View;I)Z
    ...
    .line 297
    invoke-static {p0, v5, v2}, Landroid/support/v4/app/v;->a(Ljava/util/List;Landroid/view/View;I)Z
...
.method public static a(Ljava/util/Map;Landroid/view/View;)V
    ...
    .line 374
    invoke-static {p0, v2}, Landroid/support/v4/app/v;->a(Ljava/util/Map;Landroid/view/View;)V
...
.method static synthetic b(Landroid/view/View;)Landroid/graphics/Rect;
    ...
    .prologue
    .line 31
    invoke-static {p0}, Landroid/support/v4/app/v;->c(Landroid/view/View;)Landroid/graphics/Rect;
...
.method public static b(Ljava/lang/Object;Ljava/util/ArrayList;)V
    ...
    .line 467
    invoke-static {v2, p1}, Landroid/support/v4/app/v;->b(Ljava/lang/Object;Ljava/util/ArrayList;)V
    ...
    .line 471
    invoke-static {v1}, Landroid/support/v4/app/v;->a(Ljava/util/List;)Z
...
.method private static b(Ljava/util/ArrayList;Landroid/view/View;)V
    ...
    .line 354
    invoke-static {p0, v2}, Landroid/support/v4/app/v;->b(Ljava/util/ArrayList;Landroid/view/View;)V
