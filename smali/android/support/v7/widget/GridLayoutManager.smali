...
.method a(Landroid/support/v7/widget/RecyclerView$n;Landroid/support/v7/widget/RecyclerView$r;Landroid/support/v7/widget/LinearLayoutManager$c;Landroid/support/v7/widget/LinearLayoutManager$b;)V
    ...
    iget-object v3, v0, Landroid/support/v7/widget/GridLayoutManager;->j:Landroid/support/v7/widget/aa;

    invoke-virtual {v3}, Landroid/support/v7/widget/aa;->i()I
    ...
    iget-object v4, v0, Landroid/support/v7/widget/GridLayoutManager;->j:Landroid/support/v7/widget/aa;
    ...
    invoke-virtual {v4, v10}, Landroid/support/v7/widget/aa;->e(Landroid/view/View;)I
    ...
    iget-object v9, v0, Landroid/support/v7/widget/GridLayoutManager;->j:Landroid/support/v7/widget/aa;

    invoke-virtual {v9, v10}, Landroid/support/v7/widget/aa;->f(Landroid/view/View;)I
    ...
    iget-object v7, v0, Landroid/support/v7/widget/GridLayoutManager;->j:Landroid/support/v7/widget/aa;

    .line 606
    invoke-virtual {v7}, Landroid/support/v7/widget/aa;->h()I
    ...
    invoke-virtual {v3, v8}, Landroid/support/v7/widget/aa;->e(Landroid/view/View;)I
    ...
    iget-object v5, v0, Landroid/support/v7/widget/GridLayoutManager;->j:Landroid/support/v7/widget/aa;

    invoke-virtual {v5, v8}, Landroid/support/v7/widget/aa;->f(Landroid/view/View;)I
