...
.method private d(Landroid/view/View;)V
    ...
    .line 5070
    invoke-static {v0}, Landroid/support/v7/widget/RecyclerView;->p(Landroid/support/v7/widget/RecyclerView;)Landroid/support/v7/widget/ab;

    move-result-object v0

    invoke-virtual {v0}, Landroid/support/v7/widget/ab;->b()Landroid/support/v4/view/a;
...
.method a(IIZ)Landroid/support/v7/widget/RecyclerView$u;
    ...
    invoke-static {v4}, Landroid/support/v7/widget/RecyclerView$r;->g(Landroid/support/v7/widget/RecyclerView$r;)Z
    ...
    iget-object v0, v0, Landroid/support/v7/widget/RecyclerView;->d:Landroid/support/v7/widget/o;

    invoke-virtual {v0, p1, p2}, Landroid/support/v7/widget/o;->a(II)Landroid/view/View;
    ...
    iget-object v1, v1, Landroid/support/v7/widget/RecyclerView;->d:Landroid/support/v7/widget/o;
    ...
    iget-object v3, v3, Landroid/support/v7/widget/RecyclerView;->d:Landroid/support/v7/widget/o;

    invoke-virtual {v3, v1}, Landroid/support/v7/widget/o;->d(I)V
...
.method a(IZ)Landroid/view/View;
    ...
    iget-object v2, v2, Landroid/support/v7/widget/RecyclerView;->i:Landroid/support/v7/widget/RecyclerView$r;
    ...
    invoke-virtual {v0, v4, v5}, Landroid/support/v7/widget/RecyclerView$a;->c(Landroid/view/ViewGroup;I)Landroid/support/v7/widget/RecyclerView$u;
    ...
    iget-object v3, v3, Landroid/support/v7/widget/RecyclerView;->h:Landroid/support/v7/widget/RecyclerView$e;

    iget-object v6, p0, Landroid/support/v7/widget/RecyclerView$n;->c:Landroid/support/v7/widget/RecyclerView;

    iget-object v6, v6, Landroid/support/v7/widget/RecyclerView;->i:Landroid/support/v7/widget/RecyclerView$r;
...
.method b(Landroid/support/v7/widget/RecyclerView$u;)V
    ...
    invoke-virtual {v2, p1}, Landroid/support/v7/widget/ap;->g(Landroid/support/v7/widget/RecyclerView$u;)V
...
.method e(Landroid/support/v7/widget/RecyclerView$u;)V
    ...
    invoke-static {v0}, Landroid/support/v7/widget/RecyclerView;->q(Landroid/support/v7/widget/RecyclerView;)Landroid/support/v7/widget/RecyclerView$o;
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/ap;->g(Landroid/support/v7/widget/RecyclerView$u;)V
